    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/admin/verifyNumber").permitAll()
                .requestMatchers("/api/admin/sendOTP").permitAll()
                .requestMatchers("/api/admin/verifyOTP").permitAll()
                ...
                .requestMatchers("/api/subscriber/plans").permitAll() // Allow plans without authentication
                // Secured endpoints
